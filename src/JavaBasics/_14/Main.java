...
public class Main {
    ...
    private static void exercise4() {
        ...
        int tableEight = 8;
        for (
                int timesTableCurrentValue = tableEight; // <---- Edit this line
                timesTableCurrentValue <= tableEight * 10; // <---- Edit this line
                timesTableCurrentValue = timesTableCurrentValue + tableEight // <---- Edit this line
        ) {
    ...
    private static void exercise5() {
        ...
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++) {
            System.out.println("Tabellina dell' : " + timesTableNumber);

            for (int timeTablesCorrentValue = timesTableNumber; timeTablesCorrentValue <= timesTableNumber * 10; timeTablesCorrentValue += timesTableNumber){
                System.out.println(timeTablesCorrentValue);
