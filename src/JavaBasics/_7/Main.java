...
public class Main {
    ...
    private static void exercise1() {
        ...
        String lunch = "Riso con tonno";
        String dinner = "Hamburger";
        String completeFood = lunch.toUpperCase() + ", " + dinner.toLowerCase();
        System.out.println(completeFood);
    }
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + 1 + "b"; // <--- Edit this line
