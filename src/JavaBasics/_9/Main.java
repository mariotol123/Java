...
public class Main {
    ...
    private static void exercise2() {
        ...
        if (lunchCost > remainingMoney) {
            System.out.println("U go hungry today");
        } else {
    ...
    private static void exercise3() {
        ...
        if (ourDouble > double2){
            System.out.println("Maggiore di =" + double2);
        } else if (ourDouble < double2){
            double double3 = ourDouble + 1.0;
            System.out.println("Inferiore a= " + double2);
        } else {
            System.out.println("Maggiore di = " + double2);
        }
    }
    ...
    private static void exercise4() {
        ...
        if (employeeAge >= 65){
            ...
            System.out.println("Experienced Worked");
