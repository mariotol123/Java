...
public class Main {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2a:");
        char ourChar = 'a';
        String ourCharString = String.valueOf("a"); // <--- Change this line
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4:");
        String startStr = "5";
        int newInteger = Integer.valueOf(startStr);
        int number2 = newInteger * 2;
        System.out.println(number2);

        String newStr = String.valueOf(number2);
        String str2 = newStr + "10";

        System.out.println(str2);

        double newDou = Double.valueOf(str2);
        double dou2 = newDou / 3.5;

        System.out.println(dou2);

        double definitiveDouble = Math.floor(dou2);
        System.out.println(definitiveDouble);
