...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(10,"Pizza");
        myFirstMap.put(20,"Kebab");
        myFirstMap.put(5,"Cornetto");
        // 1c. Print the map
        System.out.println(myFirstMap);
        // 1d. Access an element in the map with .get
        System.out.println(myFirstMap.get(20));
        // 1e. Remove an element from the map .remove
        System.out.println(myFirstMap.remove(5));
    ...
    private static void exercise3() {
        ...
        for (int value : fruitWeights.values()){
            totalWeight += value;
        }
